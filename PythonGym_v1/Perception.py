...
class Perception:
    def __init__(self, perception_array: list[int]) -> None:
        ...
        self.life_x:float = perception_array[16]
        self.life_y:float = perception_array[17]
    ...
    def __repr__(self):
        return (f"Perception(Up={self.neighborhood_up}, Down={self.neighborhood_down}, "
                ...
                f"Life_X={self.life_x}, Life_X={self.life_x}")
    
def object_in_map(map: list[list[Object]], x: int, y: int) -> Object:
    return map[x][y]
